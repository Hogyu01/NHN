...
const INGREDIENTS = Object.freeze({
  ...
  schemaVersion: 1,
  ingredients: [
    canonicalIngredient("ingredient.slime_gel", "MONSTER_BYPRODUCT", 8, 100, 12, 16),
    canonicalIngredient("ingredient.cave_mushroom", "VEGETABLE", 9, 100, 7, 14),
    ...
    canonicalIngredient("ingredient.crystal_salt", "MINERAL", 5, 100, 8, 18),
    canonicalIngredient("ingredient.stonegrain", "HERB", 7, 90, 9, 18),
    canonicalIngredient("ingredient.griffin_egg", "MEAT", 22, 45, 2, 6),
    canonicalIngredient("ingredient.mimic_bean", "FRUIT", 16, 100, 6, 7),
